...
exports.remedialValidator = [
  ...
  body('targetSemester').optional().isInt().withMessage('Target semester must be an integer'),
  body('targetSection').optional().isMongoId().withMessage('Invalid target section ID'),
