...
export const StylePreview = () => {
  ...
  const sampleColumns = [
    ...
    {
      header: "Status",
      cell: (item) => <StatusBadge status={item.status} label={item.status} />,
    },
  ];
  ...
  return (
    <DashboardShell title="Style Preview">
      <PageHeader
        ...
        action={
          <Button onClick={() => setShowConfirm(true)}>Show Dialog</Button>
        }
      />
              ...
              notifications={[
                {
                  ...
                  message: "B.Tech Sem 4 results are out.",
                  time: "2m ago",
                  read: false,
                },
                {
                  id: "2",
                  title: "Risk Alert",
                  message: "5 new students moved to high risk.",
                  time: "1h ago",
                  read: false,
                },
                {
