    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-white overflow-hidden p-0 gap-0">
        ...
        <div className="overflow-y-auto max-h-[80vh] px-6 py-6">
          {error && (
            <div className="bg-red-50 text-red-600 text-sm p-3 rounded-md mb-4 border border-red-200 shadow-sm flex items-start gap-2">
                ...
                {isEditing && formData.avatar && (
                  <div className="flex gap-2 mt-1">
                    <Button
                      ...
                      className="h-7 text-xs text-red-600 hover:text-red-700 hover:bg-red-50 px-2 rounded"
                    >
              ...
              {user.role === "STUDENT" && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-3 bg-white border border-slate-100 rounded-lg shadow-sm col-span-2">
                      <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1 flex items-center gap-1.5">
                        <UserIcon className="w-3 h-3" /> Class Teacher
                      </p>
                      <p className="text-sm font-semibold text-slate-800">
                        {studentProfile?.classTeacherId
                          ? studentProfile.classTeacherId.firstName
                            ? `${studentProfile.classTeacherId.firstName} ${studentProfile.classTeacherId.lastName || ""}`
                            : studentProfile.classTeacherId.username
                          : "-"}
                      </p>
                    </div>
                  </div>
