...
export const AttendanceModal = ({
  ...
  const downloadPdf = () => {
    ...
    doc.text(
      `Time: ${formatTimeAMPM(session.startTime)} - ${formatTimeAMPM(session.endTime)}`,
      rightColX,
      38,
    );
        ...
        <div className="px-6 py-3 bg-white border-b flex justify-between items-center shrink-0">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1.5 text-xs font-medium bg-emerald-50 text-emerald-700 rounded border border-emerald-200 hover:bg-emerald-100"
            >
              Mark All Present
            </button>
            <button
              onClick={() => markAll(false)}
              className="px-3 py-1.5 text-xs font-medium bg-rose-50 text-rose-700 rounded border border-rose-200 hover:bg-rose-100"
            >
              Mark All Absent
            </button>
          </div>
                    ...
                    >
                      ...
                      <td className="p-3 text-center">
                        <input
                          ...
                          onChange={(e) =>
                            handleToggle(record.studentId._id, e.target.checked)
                          }
                        />
                      </td>
                    </tr>
