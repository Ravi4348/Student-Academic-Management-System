      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={["CTPO"]} />}>
            ...
            <Route
              path="/ctpo/at-risk"
              element={<Navigate to="/ctpo/students?risk=AT-RISK" replace />}
            />
          </Route>
          ...
          <Route element={<ProtectedRoute allowedRoles={["PRINCIPAL"]} />}>
            ...
            <Route
              ...
              element={<PrincipalCampusOverview />}
            />
            ...
            <Route
              ...
              element={<PrincipalGuestLectures />}
            />
          </Route>
          ...
          <Route element={<ProtectedRoute allowedRoles={["COORDINATOR"]} />}>
            ...
            <Route
              ...
              element={<CoordinatorRemedialClasses />}
            />
            <Route
              path="/coordinator/backlog-students"
              element={<CoordinatorBacklogStudents />}
            />
            <Route
              path="/coordinator/attendance"
              element={<CoordinatorAttendanceProgress />}
            />
            <Route
              path="/coordinator/guest-lectures"
              element={<CoordinatorGuestLectures />}
            />
            <Route
          ...
          <Route element={<ProtectedRoute allowedRoles={["ADMIN"]} />}>
            ...
            <Route
              ...
              element={<AdminCampusBranchLink />}
            />
            <Route
              path="/admin/academic-years"
              element={<AdminAcademicYears />}
            />
            ...
            <Route
              ...
              element={<AdminSystemConfiguration />}
            />
